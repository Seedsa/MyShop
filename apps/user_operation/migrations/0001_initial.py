    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 23, 17, 11, 20, 285599), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '收货地址',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 23, 17, 11, 20, 284597), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '用户收藏',
