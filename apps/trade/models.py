...
class OrderInfo(models.Model):
    ...
    user = models.ForeignKey(User, verbose_name=u'用户',on_delete=models.CASCADE)
    order_sn = models.CharField(max_length=30, unique=True, default='',verbose_name='订单编号')
    trade_no = models.CharField(max_length=100, unique=True, null=True, blank=True, verbose_name=u'支付编号')
