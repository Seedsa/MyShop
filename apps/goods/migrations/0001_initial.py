# Generated by Django 2.1 on 2018-08-23 09:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 23, 17, 11, 20, 261516), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '轮播图片',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 23, 17, 11, 20, 260514), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(2, '二级类目'), (1, '一级类目'), (3, '三级类目')], help_text='类目级别', max_length=20, verbose_name='类目级别')),
                ('is_tab', models.BooleanField(default=False, help_text='是否导航', verbose_name='是否导航')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 23, 17, 11, 20, 258509), help_text='添加时间', verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 23, 17, 11, 20, 259536), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '品牌',
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(blank=True, help_text='商品类目', on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='商品类目'),
        ),
        migrations.AddField(
            model_name='banner',
            name='goods',
